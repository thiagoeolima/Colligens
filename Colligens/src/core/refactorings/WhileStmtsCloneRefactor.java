...
public class WhileStmtsCloneRefactor implements Visitor{
	...
	public void run(WhileStatement node) {
		VisitorConditionalChecker condChecker = new VisitorConditionalChecker();
		node.accept(condChecker);
		
		
		if (condChecker.containConditional()){

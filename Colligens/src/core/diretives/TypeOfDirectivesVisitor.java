...
public class TypeOfDirectivesVisitor implements Visitor {

	private List<Opt> conditionals = new ArrayList<>();
	
	public List<Opt> getConditionals() {
		return conditionals;
	}

	public void setConditionals(List<Opt> conditionals) {
	...
	public void run(Opt node) {
		...
		if (parent instanceof CompoundStatement || parent instanceof TranslationUnit){

...
public class Refactor {
	...
	public void refactorNode (Node node){
		...
		if (conditionals.size() == 1){
			...
			if (nodeClone2 instanceof IfStatement && nodeClone1 instanceof IfStatement){
				if (nodeClone2.getChildren().size() > 0){
					if (nodeClone2.getChildren().get(0) instanceof Choice){
						if (nodeClone2.getChildren().size() > 0){
							if (nodeClone2.getChildren().get(0).getChildren().size() > 1){
								nodeClone2.getChildren().get(0).getChildren().remove(1);
							}
						}	
					}
				}
				if (nodeClone1.getChildren().size() > 0){
					if (nodeClone1.getChildren().get(0).getChildren().size() > 0){
						if (nodeClone1.getChildren().get(0).getChildren().size() == 2){
							nodeClone1.getChildren().get(0).getChildren().remove(0);
						}
					}
				}
			}
			...
			if (index >= 0){
				...
				for (int i = 0; i < conditionals.size(); i++){
					...
					if (clone instanceof IfStatement){
						if (clone.getChildren().size() > 0){
							if (clone.getChildren().get(0) instanceof Choice){
								if (i == 0){
									if (clone.getChildren().size() > 0){
										if (clone.getChildren().get(0).getChildren().size() > 1){
											clone.getChildren().get(0).getChildren().remove(1);
										}
									}
								} else if (i == 1){
									if (clone.getChildren().size() > 0){
										if (clone.getChildren().get(0).getChildren().size() > 0){
											clone.getChildren().get(0).getChildren().remove(0);
											if (clone.getChildren().get(0).getChildren().size() > 0 && clone.getChildren().get(0).getChildren().get(0).getChildren().size() > 1){
												clone.getChildren().get(0).getChildren().get(0).getChildren().remove(1);
											}
										}
									}
								} else if (i == 2){
									if (clone.getChildren().size() > 0){
										if (clone.getChildren().get(0).getChildren().size() > 0){
											clone.getChildren().get(0).getChildren().remove(0);
											if (clone.getChildren().get(0).getChildren().size() > 0 && clone.getChildren().get(0).getChildren().get(0).getChildren().size() > 0){
												clone.getChildren().get(0).getChildren().get(0).getChildren().remove(0);
												if (clone.getChildren().get(0).getChildren().get(0).getChildren().get(0).getChildren().size() > 1){
													clone.getChildren().get(0).getChildren().get(0).getChildren().get(0).getChildren().remove(1);
												}
											}
										}
									}
								} else if (i == 3){
									if (clone.getChildren().size() > 0 && clone.getChildren().get(0).getChildren().size() > 0){
										clone.getChildren().get(0).getChildren().remove(0);
										if (clone.getChildren().get(0).getChildren().get(0).getChildren().size() > 0){
											clone.getChildren().get(0).getChildren().get(0).getChildren().remove(0);
											if (clone.getChildren().get(0).getChildren().get(0).getChildren().get(0).getChildren().size() > 0){
												clone.getChildren().get(0).getChildren().get(0).getChildren().get(0).getChildren().remove(0);
											}
										}
									}
					...
					//clone.accept(new VisitorPrinter(false));
	...
	public Node createDeclarationStatement(String identifier, Node type, Node value){
		...
		declStmt.getChildren().add(declaration);
		declaration.setParent(declStmt);
